        ...
        <div className = "insuranceContents">
            <div className = "insuranceCards">
                ...
                <div className = "insuranceCard">
                    ...
                    <a className="documentLink" href="https://content.tgstatic.co.nz/webassets/globalassets/terms-and-conditions/turners-car-tpft-vcpctpft-policy-book-062018-used26032021-current.pdf" target="_blank" rel="noreferrer">View Policy Document</a><br></br>
                    <Link to='/insurance/details'>
                        <button type="button" className="selectQuoteButton">Select</button>
                    </Link>
                </div>
                <div className = "insuranceCard">
                    ...
                    <a className="documentLink" href="https://content.tgstatic.co.nz/webassets/globalassets/terms-and-conditions/turners-car-tppd-vcpctp-policy-book-062018-used26032021-current.pdf" target="_blank" rel="noreferrer">View Policy Document</a><br></br>
                    <Link to='/insurance/details'>
                        <button type="button" className="selectQuoteButton">Select</button>
                    </Link>
                </div>
